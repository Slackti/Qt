...
{
   QMessageBox::about(this, tr("About QHexEdit2"),
            tr("The QHexEdit2 is a App of the QHexEdit Widget."));
}
...
void MainWindow::saveSelectionToReadableFile()
{
    ...
    if (!fileName.isEmpty())
    {
        ...
        if (!file.open(QFile::WriteOnly | QFile::Text)) {
            QMessageBox::warning(this, tr("QHexEdit2"),
...
void MainWindow::setCurrentFile(const QString &fileName)
{
    ...
    if (fileName.isEmpty())
        setWindowFilePath("QHexEdit2");
    else
        setWindowFilePath(curFile + " - QHexEdit2");
}
